...
#Objective Function
maximize profit: p[1]*X[1]+p[2]*X[2]+p[3]*X[3] - 0.06*(3000000 - sum{i in I,j in J} T[i,j]);

#Constraints:
subject to Supply: sum {i in I,j in J}T[i,j] <= 3000000;
subject to AGrade: sum{i in I}T[i,1] <= 600000;
